...
**ALX SE Poroject** - Loops, conditions and parsing (`while`, `until` and `for`), condition statements (`if`, `else`, `elif` and `case`), shebangs and how to create SSH keys with <strong>Bash</strong>.
